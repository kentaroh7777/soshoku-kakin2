            ...
            <>
                ...
                <div className="sign-container">
                    ...
                    <div className="sign-element-container">
                        ...
                        <input type="text" value={user.email} readOnly placeholder="メールアドレス" />
                    </div>
                    <div className="sign-element-container">
                        <h3 className="sign-head-text">ニックネーム</h3>
                        <input type="text" value={user.nickname} readOnly placeholder="ニックネーム" />
                    </div>
                    <div className="sign-element-container">
                        <h3 className="sign-head-text">プロフィールテキスト</h3>
                        <input type="text" value={user.profileText} readOnly placeholder="プロフィールテキスト" />
                    </div>
